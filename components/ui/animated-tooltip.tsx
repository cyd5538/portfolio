        ...
        >
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs w-40 sm:w-60 h-auto flex-col items-center justify-center rounded-md bg-sky-500 dark:bg-blue-900 z-50 shadow-xl px-4 py-2"
            >
