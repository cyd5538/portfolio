...
const ProjectBtn: React.FC<ProjectBtnProps> = () => {
  return (
    <button className="mt-2 p-2 rounded-md border dark:bg-zinc-800 dark:text-white bg-white text-neutarl-700 text-sm hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)]  transition duration-200">
      자세히 보기
    </button>
  );
};
